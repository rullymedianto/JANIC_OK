...
function [AA1,conflict_prop1,max_aircraftinsector, mean_time,sec_demand,max_conflictinsector] = Gabungan()
...
if Sim1{1,i+1}(2,j) > 9000000
 ...
 Sim1{1,i+1}(24,j)= LOS(ROW_Detail{1,i},Conflict_1{1,i},airplane,j,Distance_XY{1,i},conflict_separation_1,conflict_separation_2,Sim1{1,i+1}(4,j)); % Lost of Separation
   ...
   [Sim1{1,i+1}(30,j),Sim1{1,1}(31,i)] = clearance(ROW_Detail{1,i},Conflict_1{1,i},airplane,j,Distance_XY{1,i},conflict_separation_1,conflict_separation_2,Sim1{1,i+1}(4,j),Holding_status{1,i}(1,j),Conflict_3{1,i},Distance_Merg{1,i}); %Status Conflict
