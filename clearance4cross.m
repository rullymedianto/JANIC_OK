function [y] = clearance4cross(ROW,conflict,airplane,j,distance,buffer_zone_1,buffer_zone_2,height,hold_status,conflict3,distancemerg)
iki=conflict;
...
for i = 1:row
temp2(1,i) = temp1(1,i);
temp2(2,i) = conflict3(1,(temp1(1,i)));
...
%            y = 1;      
       ...
       elseif it_2(2,column1-1) == 1 && distance(j,k) < buffer_zone % || distancemerg (j,k)< buffer_zone) %%Revisi di sini
           y = 0;
