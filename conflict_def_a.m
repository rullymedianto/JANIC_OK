function y = conflict_def(ROW,conflict_xy,airplane,j)
...
elseif conflict_xy(1,j) == 1
    if column1 == 1
       ...
       elseif it_2(2,column1-1) == 1 && conflict_xy(j,k) == 1 %&& distance(j,k) > buffer_zone && distancemerg (j,k)> buffer_zone
           y = 1;
