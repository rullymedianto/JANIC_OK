...
[Sim1{1,i+1}(9,j), Sim1{1,i+1}(31,j)]= clearance_a(ROW_Detail{1,i},Conflict_1{1,i},airplane,j,Conflict_4{1,i});
        % 0 : No clearance
        % 1 : Clearance
end
%Resolution (10)
...
if Sim1{1,i+1}(2,j) > 9000000
 ...
 Sim1{1,i+1}(24,j)= LOS(ROW_Detail{1,i},Conflict_1{1,i},airplane,j,Distance_XY{1,i},conflict_separation_1,conflict_separation_2,Sim1{1,i+1}(4,j)); % Lost of Separation
   ...
   Sim1{1,i+1}(30,j) = clearance(ROW_Detail{1,i},Conflict_1{1,i},airplane,j,Distance_XY{1,i},conflict_separation_1,conflict_separation_2,Sim1{1,i+1}(4,j),Holding_status{1,i}(1,j),Conflict_3{1,i},Distance_Merg{1,i}); %Status Potential Conflict
