function [y] = noclearcross(ROW,airplane,j,buffer_zone_1,buffer_zone_2,height,conflict3,distancemerg)
...
elseif conflict3(1,j)==1
    if column1 == 1
       ...
       k = it_2(1,column1-1);
       if it_2(2,column1-1) == 0 &&  distancemerg (j,k)> buffer_zone 
           y = 0;
          
       elseif it_2(2,column1-1) == 1 && distancemerg (j,k)> buffer_zone
           y = 0;
           
       elseif it_2(2,column1-1) == 0 &&  distancemerg (j,k)< buffer_zone
           y = 0;
