function [AA1,conflict_prop1,max_aircraftinsector,ULT_CAP, mean_time, max_conflictinsector,correlat] = Gabungan_A()
...
correlat = Cor_wkld(2,1);% Correlation workload-complexity
